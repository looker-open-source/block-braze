- dashboard: braze_campaign_overview
  ...
  - title: Conversion Rate
    ...
    width: 4
    height: 3
  - title: Aggregate Funnel
    name: Aggregate Funnel
    model: block_braze
    explore: campaign
    type: looker_column
  ...
  - title: Channel Conversions Over Time
    ...
    fill_fields: [campaign_conversion_event.time_date]
    filters:
      campaign.channel: "-NULL"
  ...
  - title: Campaign Metrics Over Time
    ...
    fill_fields: [email_event.time_date]
    ...
    y_axes: [{label: '', orientation: left, series: [{axisId: email_event.count, id: email_event.count,
            name: Total Email Impressions}], showLabels: false, showValues: true,
        unpinAxis: false, tickDensity: default, type: linear}, {label: '', orientation: left,
        series: [{axisId: email_event.total_clicks, id: email_event.total_clicks,
            name: Total Clicks}], showLabels: false, showValues: false, unpinAxis: false,
        tickDensity: default, type: linear}, {label: '', orientation: right, series: [
          {axisId: campaign_conversion_event.conversion_rate, id: campaign_conversion_event.conversion_rate,
            name: Conversion Rate}], showLabels: false, showValues: true, unpinAxis: false,
  ...
  - title: Conversions and Audience by Device
    ...
    color_application:
      ...
      options:
        steps: 5
    y_axes: [{label: '', orientation: bottom, series: [{axisId: campaign.estimated_audience,
            id: campaign.estimated_audience, name: Estimated Audience}], showLabels: false,
        showValues: false, unpinAxis: false, tickDensity: default, type: linear},
      {label: '', orientation: bottom, series: [{axisId: campaign_conversion_event.conversion_rate,
            id: campaign_conversion_event.conversion_rate, name: Conversion Rate}],
    ...
    series_types:
      campaign_conversion_event.conversion_rate: line
    series_colors:
      campaign.estimated_audience: "#8dd3c7"
      conversions: "#80b1d3"
      audience: "#8dd3c7"
      conversion_rate: "#fb8072"
      campaign_conversion_event.conversion_rate: "#fb8072"
    custom_color_enabled: true
    show_single_value_title: true
    show_comparison: false
    comparison_type: value
